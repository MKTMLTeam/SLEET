...
__all__ = ['resolve_format', 'load_dataset', 'ASEAtomsData', 'AtomsDataFormat', 'logger', 'extension_map', 'BaseAtomsData', 'AtomsDataError', ]
...
class ASEAtomsData(BaseAtomsData):
    ...
    def __init__(
        ...
        if distance_unit:
            self.distance_conversion = convert_units(
